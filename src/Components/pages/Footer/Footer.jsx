    ...
    <div>
      <footer className="footer p-10 text-neutral-content felx justify-between md:px-28 lg:px-36 border-2 border-t-red-300 ">
        <nav>
          ...
          <p className="md:w-1/2 text-gray-700 text-base dark:text-white">
        ...
        <nav>
          <p className=" text-3xl text-red-600 dark:text-white">123-456-78901</p>
          <a className=" text-gray-700 text-base dark:text-white">drivewave@gmail.com</a>
          <a className=" text-gray-700 text-base dark:text-white">West 12th Street</a>
          <a className=" text-gray-700 text-base dark:text-white">New York, USA</a>
        </nav>
      </footer>
    </div>
  );
